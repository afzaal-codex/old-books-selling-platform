    ...
    try {
      ...
      if (recipientEmail) {
        ...
        const orderContent = `
          ...
          <p style="font-size: 12px; color: #888888; text-align: center; margin-top: 20px;">If you have any questions, please contact support at ${process.env.ADMIN_EMAIL || 'hello@bookworld.site'}.</p>
        `;
