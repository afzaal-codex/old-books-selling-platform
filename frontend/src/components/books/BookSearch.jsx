...
const BookSearch = ({
  ...
  return (
    <form
      ...
      className="flex items-center w-full rounded-xl border border-[var(--color-border)] bg-[#111114] focus-within:border-[var(--color-primary)] transition-all duration-300"
    >
      <input
        type="text"
