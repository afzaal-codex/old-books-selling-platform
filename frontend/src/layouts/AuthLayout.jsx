...
const AuthLayout = () => {
  ...
  return (
    <motion.div
      ...
      className="
        fixed inset-0 z-50 h-screen w-screen bg-neutral-950/98 backdrop-blur-xl overflow-y-auto px-4 pt-3 pb-6 flex flex-col
    ...
    >
      {/* MOBILE HEADER */}
      <div className="flex md:hidden items-center justify-between w-full pb-4 mb-3 border-b border-white/10 z-20 flex-shrink-0">
        <button
          onClick={handleBack}
      ...
      {/* AUTH CONTAINER */}
      <div className="relative z-10 w-full max-w-md mx-auto mt-0 md:my-auto flex-1 flex flex-col justify-start md:justify-center">
        <Outlet />
      </div>
    </motion.div>
  );
